---
name: roadmap-to-release-plan
description: Use when converting roadmap notes, feature lists, planning docs, or backlog themes into a release plan with milestones, scope, dependencies, rollout phases, and validation checks.
---
